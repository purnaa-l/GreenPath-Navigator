...
def main():
    ...
    st.write("""
    Welcome to the Sustainability Chatbot! Ask questions related to sustainability practices and eco-friendly solutions. 
    The model will respond based on the information from the uploaded content.
    """)
    
    # Split the content into chunks and generate vector store
    ...
    if user_question:
        ...
        # Display the response in a fancy format
        st.markdown(f"### Chatbot Response:\n\n{response}")
        st.markdown("**Let's make the world more sustainable, one step at a time!**")
