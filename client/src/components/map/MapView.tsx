// import { MapContainer, TileLayer, Marker, Popup, LayersControl, LayerGroup, Polyline, Tooltip, useMap } from "react-leaflet";
...
//   // Define paths for sustainable paths and bike ride path (remains the same)
...
//       // Add all markers to map for each specific category (Buildings, Departments, etc.)
//       const buildingLayer = new L.LayerGroup();
//       const departmentLayer = new L.LayerGroup();
//       const otherMarkersLayer = new L.LayerGroup();
...
//         // Categorize markers into layers
//         if (marker.category === "Building") {
//           buildingLayer.addLayer(leafletMarker);
//         } else if (marker.category === "Department") {
//           departmentLayer.addLayer(leafletMarker);
//         } else {
//           otherMarkersLayer.addLayer(leafletMarker);
//         }
//       });

//       // Add categorized layers to the map
//       layerGroup.addLayer(buildingLayer);
//       layerGroup.addLayer(departmentLayer);
//       layerGroup.addLayer(otherMarkersLayer);
...
//       <MapContainer center={[12.3365759, 76.61707]} zoom={18} className="w-full h-full" ref={mapRef}>
//         <SearchControl />
...
//             <LayerGroup>
//               {MarkersData.filter((marker) => marker.category === "Building").map((marker, index) => (
...
//           <LayersControl.Overlay name="Departments">
//             <LayerGroup>
//               {MarkersData.filter((marker) => marker.category === "Department").map((marker, index) => (
//                 <Marker key={index} position={marker.position}>
//                   <Popup>
//                     <h3>{marker.name}</h3>
//                     <p>{marker.description}</p>
...
//           <LayersControl.Overlay name="Other Markers">
//             <LayerGroup>
//               {MarkersData.filter((marker) => marker.category !== "Building" && marker.category !== "Department").map((marker, index) => (
//                 <Marker key={index} position={marker.position}>
//                   <Popup>
//                     <h3>{marker.name}</h3>
//                     <p>{marker.description}</p>
...
//             <LayerGroup>
//               {Object.entries(sustainablePaths).map(([pathName, pathCoordinates], index) => (
//                 <Polyline
//                   key={index}
...
//                 }}
//               >
//                 <Popup>Biking Path - Check for nearby stations</Popup>
//               </Polyline>
//             </LayerGroup>
//           </LayersControl.Overlay>
//         </LayersControl>
